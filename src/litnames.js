...
// СКЛЕЙКА БОЛЬШЕ НЕ НУЖНА. Она возникла из-за неверных швов между томами:
// блоки за швом съезжали, словарь у них не читался, и это выглядело как
// «продолжения без заголовка». После починки швов (lit.js, fixSeams) заголовок
// со словарём есть у всех 245 518 блоков, и каждый блок самодостаточен —
// groups() теперь возвращает по одному блоку на группу. Оставлено, чтобы не
// ломать вызовы; удалить вместе со следующей чисткой.
